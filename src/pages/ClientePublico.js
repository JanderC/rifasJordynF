...
function calcularPrecioMetodo(precioCOP, metodo, tasaBsUSD, copUsd = 4200) {
  ...
  if (moneda === "VES") {
    ...
    return {
      valor: bs,
      texto: `Bs. ${new Intl.NumberFormat("es-VE", { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(bs)}`,
      moneda: "VES",
      icono: "🇻🇪",
    };
  }
        ...
        {ofertas.map((o, i) => {
          ...
          return (
            <div key={i} className="pack-card">
              ...
              >
                <span
                  style={{ fontSize: "1.1rem", color: VERDE, fontWeight: 900 }}
                >
                  {fmt(o.precio_total)}
                </span>
                <span
              ...
              >
                <span
                  style={{ fontSize: ".62rem", color: "rgba(255,255,255,.5)" }}
                >
                  {o.cantidad} números
                </span>
                <span
          ...
          {tieneOfertas && (
            <span
              style={{
                ...
                letterSpacing: "1.5px",
                textTransform: "uppercase",
                boxShadow: `0 4px 16px ${NARANJA}55`,
            ...
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
              {rifa.ofertas.map((o, i) => {
                ...
                const pct = Math.round(
                  ((totalNormal - o.precio_total) / totalNormal) * 100,
                );
                return (
                  <div
                    key={i}
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <div style={{ fontSize: ".65rem", color: `${DARK}66` }}>
            {info.pais}
          </div>
        </div>
      </div>
      {info.campos.map(({ label, valor }) => (
        <div key={label} className="pago-campo-row">
          <div>
            ...
            <div style={{ fontSize: ".9rem", fontWeight: 700, color: DARK }}>
              {valor}
            </div>
          </div>
          <button
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <span
                style={{ fontSize: ".95rem", color: VERDE, fontWeight: 900 }}
              >
                {fmt(totalConOferta)}
              </span>
              <span
        ...
        >
          ...
          <div style={{ fontSize: ".95rem", color: VERDE, fontWeight: 900 }}>
            {fmt(ahorro)}
          </div>
        </div>
      </div>
    ...
    >
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: "1.5rem", color: VERDE, fontWeight: 900 }}>
            {fmt(ahorro)}
          </div>
          <div
            style={{
...
function ModalReserva({ rifa, numeros, onClose, onSuccess }) {
  ...
  const totalReal = ofertaInfo
    ? ofertaInfo.totalConOferta
    : rifa.precio * numeros.length;
  ...
  const handleFile = (e) => {
    ...
    if (f.size > 8 * 1024 * 1024) {
      setError("La imagen debe ser menor a 8 MB");
      return;
    }
    setError("");
  ...
  const handleEnviar = async () => {
    ...
    try {
      ...
      const ids = (r.data.reservas || [r.data.reserva])
        .map((rv) => rv?.id)
        .filter(Boolean);
      setReservaIds(ids);
  ...
  const convTotal = calcularPrecioMetodo(
    totalReal,
    form.metodo_pago,
    tasaBs,
    copUsd,
  );
  const convUnitario = calcularPrecioMetodo(
    rifa.precio,
    form.metodo_pago,
    tasaBs,
    copUsd,
    ...
    >
      <div
        style={{
          ...
          maxHeight: "93vh",
          overflowY: "auto",
          boxShadow: "0 32px 80px rgba(0,60,60,.3)",
          animation: "fadeUp .3s ease",
        }}
      >
        {/* Header */}
        ...
        >
          ...
          <div style={{ fontSize: ".85rem", color: "rgba(255,255,255,.8)" }}>
            ...
            {numeros.length > 1 ? (
              ofertaInfo ? (
                <>
                  <s style={{ opacity: 0.6 }}>{fmt(totalNormal)}</s>{" "}
                  <strong style={{ color: "#b3ffd4" }}>{fmt(totalReal)}</strong>
                </>
              ) : (
        ...
        <div style={{ padding: "22px 26px 28px" }}>
          ...
          {step === 1 && (
            <div style={{ animation: "fadeUp .25s ease" }}>
              ...
              <div
                style={{
                  background: `linear-gradient(135deg,${TURQ}12,${TURQ2}18)`,
                  border: `1.5px solid ${TURQ}33`,
                  borderRadius: 14,
                  padding: "12px 16px",
                  marginBottom: 20,
                }}
              >
                ...
                <div
                  style={{
                    ...
                    flexWrap: "wrap",
                    gap: 6,
                    marginBottom: numeros.length > 1 ? 10 : 0,
                  }}
                >
                  {numeros.map((n) => (
                    <span
                ...
                {numeros.length > 1 && (
                  <div
                    style={{
                      ...
                      alignItems: "center",
                      paddingTop: 8,
                      borderTop: `1px solid ${TURQ}22`,
                    }}
                  >
                    <span style={{ fontSize: ".7rem", color: `${DARK}66` }}>
                      {fmt(rifa.precio)} × {numeros.length} números
                    </span>
                    <div style={{ textAlign: "right" }}>
                      ...
                      <span
                        style={{
                          fontSize: "1.2rem",
                          color: ofertaInfo ? VERDE : TURQ_DK,
                          fontWeight: 900,
                        }}
                      >
                        = {fmt(totalReal)}
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <div className="phone-row">
                  <select
                    ...
                    value={form.codPais}
                    onChange={(e) => upd("codPais", e.target.value)}
                  >
                    {PAISES.map((p) => (
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => upd("metodo_pago", e.target.value)}
                  style={{ cursor: "pointer" }}
                >
                  <option value="">Selecciona un método...</option>
                  {Object.keys(METODOS_PAGO).map((m) => (
                      ...
                      >
                        ...
                        <div
                          style={{
                            fontSize: "1.6rem",
                            fontWeight: 900,
                            color: ofertaInfo ? VERDE : info.colorHex,
                            lineHeight: 1,
                          }}
                        >
                          {fmt(totalReal)}
                        ...
                        {ofertaInfo && (
                          ...
                          >
                            🎁 Ahorraste {fmt(ofertaInfo.ahorro)}
                          </div>
                        )}
                        {numeros.length > 1 && !ofertaInfo && (
                          <div
                            style={{
                              fontSize: ".65rem",
                              color: `${DARK}55`,
              ...
              >
                Realiza el pago de{" "}
                <strong style={{ color: ofertaInfo ? VERDE : TURQ_DK }}>
                  {fmt(totalReal)}
                </strong>{" "}
                y sube la captura.
                {ofertaInfo && (
                ...
                {numeros.length > 1 && !ofertaInfo && (
                  <strong style={{ color: TURQ_DK }}>
                    {" "}
                    Un solo comprobante para todos los números.
                  </strong>
                )}
              </div>
              ...
              <div
                ...
                style={{
                  border: `2px dashed ${imgB64 ? TURQ : error ? "#ff6b6b" : "#c0dede"}`,
                  borderRadius: 16,
                  padding: "18px 14px",
                  textAlign: "center",
                  cursor: "pointer",
              ...
              >
                {imagen ? (
                  ...
                  <>
                    ...
                    <div
                      style={{ fontSize: ".7rem", color: "#aaa", marginTop: 4 }}
                    >
          ...
          {step === 2 && (
            ...
            >
              ...
              >
                ...
                >
                  <span
                    style={{ fontSize: "1.6rem", flexShrink: 0, marginTop: 2 }}
                  >
                    🎟
                  </span>
                  <p
                  ...
                  >
                    ...
                    <strong style={{ color: TURQ_DK }}>
                      Atento a la aprobación de su número ganador.
                    </strong>{" "}
                    Su ticket le llegará vía WhatsApp durante las próximas
                    horas.{" "}
              ...
              >
                {numeros
                  .filter((n) => !conflictos.map((c) => c.numero).includes(n))
                  .map((n) => (
                    <span
                      key={n}
                      style={{
              ...
              {ofertaInfo && (
                <div
                  style={{
                    background: "linear-gradient(135deg,#0a3a1e,#0d4a25)",
                    border: `2px solid ${VERDE}55`,
                    borderRadius: 16,
                    padding: "16px 20px",
                    marginBottom: 16,
              ...
              {conflictos.length > 0 && (
                ...
                >
                  ⚠️ Los siguientes números no pudieron reservarse porque ya
                  estaban ocupados:{" "}
                  <strong>{conflictos.map((c) => c.numero).join(", ")}</strong>
                </div>
              )}
...
function GridNumeros({ rifa, onComprar }) {
  ...
  const quickPick = (cantOverride) => {
    const cant = Math.min(
      parseInt(cantOverride ?? qpCant) || 1,
      disponibles.length,
      50,
    );
  ...
  const sugerencia = !ofertaInfo
    ? siguienteOferta(selArr.length, ofertas, rifa.precio)
    : null;
  ...
  return (
    <div>
      ...
      >
        <div style={{ flex: 1, minWidth: 180 }}>
          ...
          >
            ...
            >
              <span
                style={{ color: TURQ, fontWeight: 800, fontSize: ".88rem" }}
              >
                {disponibles.length}
              </span>{" "}
              disponibles de 1000
            ...
            <span
              style={{
                fontSize: ".72rem",
                color: pct > 80 ? "#e63946" : pct > 50 ? "#f0a500" : TURQ,
                fontWeight: 700,
              }}
            >
              {pct}% ocupado
        ...
        {disponibles.length === 0 && (
          <span
            style={{ fontSize: ".72rem", color: "#e63946", fontWeight: 700 }}
          >
            🔴 Rifa agotada
          </span>
        )}
      ...
      >
        <span style={{ fontSize: "1.1rem" }}>👆</span>
        <span>
          Puedes seleccionar <strong>uno o varios números</strong>.{" "}
          {ofertas.length > 0 && (
            <span style={{ color: NARANJA }}>
              ¡Activa ofertas al llegar a la cantidad exacta!
            </span>
          )}
        </span>
      </div>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              El sistema elige tus números al azar
            </div>
          </div>
        </div>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 800,
                    fontSize: ".88rem",
                    cursor: n > disponibles.length ? "not-allowed" : "pointer",
                    opacity: n > disponibles.length ? 0.35 : 1,
                    transition: "all .15s",
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 12,
            padding: "14px 20px",
            cursor: qpRolling ? "not-allowed" : "pointer",
            fontFamily: "'Poppins',sans-serif",
            fontWeight: 800,
            fontSize: "1rem",
            display: "flex",
          ...
          >
            ...
            {qpVisible >= qpResultado.length && (
              ...
              >
                ...
                >
                  🎯 {qpResultado.length} número
                  {qpResultado.length > 1 ? "s" : ""} marcado
                  {qpResultado.length > 1 ? "s" : ""} en el grid
                </div>
                <button
                  onClick={() => quickPick()}
                  style={{
      ...
      <div style={{ position: "relative", marginBottom: 14 }}>
        ...
        <input
          ...
          value={busqueda}
          onChange={(e) =>
            setBusqueda(e.target.value.replace(/\D/, "").slice(0, 3))
          }
          placeholder="Buscar número (ej: 007)"
      ...
      {disponibles.length === 0 ? (
        ...
        >
          ...
          >
            Esta rifa está agotada
          </div>
          <div style={{ fontSize: ".88rem", color: `${DARK}66` }}>
            Todos los números han sido vendidos o reservados
          </div>
        </div>
      ) : (
        <>
          ...
          >
            {visible.map((n) => (
              <div
                ...
                title={
                  seleccion.has(n.numero)
                    ? `Quitar ${n.numero}`
                    : `Seleccionar ${n.numero}`
                }
              >
                {n.numero}
              </div>
            ...
            {visible.length === 0 && busqueda && (
              ...
              >
                El número <strong>{busqueda.padStart(3, "0")}</strong> no está
                disponible
              </div>
            )}
          </div>
          ...
          >
            Mostrando {visible.length} número{visible.length !== 1 ? "s" : ""}{" "}
            disponible{visible.length !== 1 ? "s" : ""}
          ...
          >
              ...
              <div className="oferta-sugerencia" style={{ marginBottom: 12 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  >
                    ...
                    número{sugerencia.faltan > 1 ? "s" : ""} más y activa{" "}
                    <strong style={{ color: `${NARANJA}ee` }}>
                      {sugerencia.oferta.etiqueta ||
                        `Pack x${sugerencia.oferta.cantidad}`}
                    </strong>
                    !
                  </span>
                </div>
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                >
                  {selArr.length} número{selArr.length > 1 ? "s" : ""}{" "}
                  seleccionado{selArr.length > 1 ? "s" : ""}
                </div>
              ...
              <button
                className="pub-btn"
                onClick={() => onComprar(selArr)}
                style={{
                  flexShrink: 0,
                  borderRadius: 14,
                  padding: "12px 22px",
                  fontSize: ".9rem",
                  boxShadow: `0 8px 24px ${TURQ}55`,
                }}
              >
                🎟{" "}
                {selArr.length > 1
                  ? `Comprar ${selArr.length} números`
                  : "Comprar número"}
              </button>
            </div>
          </div>
...
function RifaCard({ rifa, onSeleccionar }) {
  ...
  const mejorOferta = tieneOfertas
    ? [...rifa.ofertas].sort((a, b) => {
        const pctA =
          (rifa.precio * a.cantidad - a.precio_total) /
          (rifa.precio * a.cantidad);
        const pctB =
          (rifa.precio * b.cantidad - b.precio_total) /
          (rifa.precio * b.cantidad);
        return pctB - pctA;
      })[0]
    : null;
  ...
  const mejorPct = mejorOferta
    ? Math.round(
        ((rifa.precio * mejorOferta.cantidad - mejorOferta.precio_total) /
          (rifa.precio * mejorOferta.cantidad)) *
          100,
      )
    : 0;
  ...
  return (
    <div
      style={{
        ...
        borderRadius: 24,
        overflow: "hidden",
        boxShadow: "0 4px 24px rgba(10,100,100,.08)",
        transition: "transform .2s, box-shadow .2s",
        position: "relative",
      }}
      onMouseEnter={(e) => {
        e.currentTarget.style.transform = "translateY(-6px)";
        e.currentTarget.style.boxShadow = `0 16px 48px rgba(10,180,180,.15)`;
      }}
      onMouseLeave={(e) => {
        e.currentTarget.style.transform = "";
        e.currentTarget.style.boxShadow = "0 4px 24px rgba(10,100,100,.08)";
      }}
    >
      <div
        style={{
          ...
          height: 220,
          overflow: "hidden",
          background: `linear-gradient(135deg,${TURQ}22,${TURQ2}33)`,
        }}
      >
        {tieneImagen ? (
          <img
          ...
          >
            ...
            <div
              style={{ fontSize: ".75rem", color: TURQ_DK, fontWeight: 600 }}
            >
              {rifa.premio}
            </div>
          </div>
        ...
        >
          <span style={{ fontSize: ".72rem", color: TURQ_DK, fontWeight: 700 }}>
            {fmt(rifa.precio)}
          </span>
        </div>
      </div>
      ...
      <div style={{ padding: "18px 22px 22px" }}>
        ...
        <div
          style={{
            fontSize: ".88rem",
            color: `${DARK}77`,
            marginBottom: tieneOfertas ? 10 : 14,
            display: "flex",
            alignItems: "center",
            gap: 5,
          }}
        ...
        {tieneOfertas && (
          <div
            style={{
              background: `${NARANJA}0d`,
              border: `1px solid ${NARANJA}33`,
              borderRadius: 10,
              padding: "8px 12px",
              marginBottom: 12,
            }}
          >
            ...
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
              {rifa.ofertas.map((o, i) => {
                ...
                const p = Math.round(
                  ((totalN - o.precio_total) / totalN) * 100,
                );
                return (
                  <div
                    key={i}
        ...
        <div style={{ marginBottom: 14 }}>
          ...
          >
            <span style={{ fontSize: ".56rem", color: `${DARK}66` }}>
              {rifa.numeros_vendidos} vendidos
            </span>
            <span style={{ fontSize: ".56rem", color: TURQ }}>
              {pct.toFixed(1)}%
            </span>
          </div>
          <div
    ...
    <div style={{ minHeight: "100vh", background: "#f0fafa" }}>
      ...
      {loading ? (
        <div style={{ padding: "5vw", maxWidth: 1100, margin: "0 auto" }}>
          <div
            className="shimmer"
            style={{ height: 520, borderRadius: 28 }}
          ></div>
        </div>
      ) : rifaHero ? (
        <section
          style={{ padding: "40px 5vw 0", maxWidth: 1100, margin: "0 auto" }}
        >
      ...
      {rifasSecundarias.length > 0 && (
        <section
          id="rifas-sec"
          style={{ padding: "60px 5vw 0", maxWidth: 1100, margin: "0 auto" }}
        >
          ...
          >
            {rifasSecundarias.map((r) => (
              <RifaCard key={r.id} rifa={r} onSeleccionar={handleSelRifa} />
            ))}
          </div>
        </section>
      )}
        ...
        >
          <div
            style={{
              ...
              borderRadius: 24,
              padding: "28px",
              boxShadow: "0 4px 32px rgba(10,100,100,.08)",
            }}
          >
            <div
              style={{
            ...
            >
              <div>
                ...
                <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
                  <span style={{ fontSize: ".85rem", color: `${DARK}77` }}>
                    🏆 {rifaSel.premio}
                  </span>
                  <span style={{ fontSize: ".85rem", color: `${DARK}77` }}>
                    💰 {fmt(rifaSel.precio)} / número
                  </span>
                  <span style={{ fontSize: ".85rem", color: `${DARK}77` }}>
                    📅 {fmtF(rifaSel.fecha_sorteo)}
                  </span>
                </div>
              </div>
              <button
              ...
              {[
                {
                  n: "1",
                  t: "Selecciona",
                  d: "Toca uno o varios números. ¡Activa ofertas con packs!",
                },
                {
                  n: "2",
                  t: "Paga",
                  d: "Los datos del banco aparecen al elegir el método",
                },
                {
                  n: "3",
                  t: "Confirma",
                  d: "Sube el comprobante y bloquea tus números",
                },
              ].map(({ n, t, d }) => (
                <div
                  key={n}
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: ".74rem", color: `${DARK}66` }}>
                      {d}
                    </div>
                  </div>
                </div>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          >
            {[
              {
                icon: "🔢",
                titulo: "1. Elige tus números",
                desc: "Toca uno o varios números en el grid. ¡Con packs activas ofertas automáticamente!",
              },
              {
                icon: "💳",
                titulo: "2. Realiza el pago",
                desc: "Los datos del banco aparecen al seleccionar el método. Paga el total con oferta.",
              },
              {
                icon: "📸",
                titulo: "3. Sube el comprobante",
                desc: "Adjunta la captura del pago junto con tus datos. Un comprobante para todos.",
              },
              {
                icon: "✅",
                titulo: "4. Confirmación",
                desc: "El admin verifica y te envía tu ticket por WhatsApp.",
              },
              ...
              >
                <div
                  style={{
                    width: 62,
                    height: 62,
                    background: `linear-gradient(135deg,${TURQ}18,${TURQ2}28)`,
                    borderRadius: 18,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
      ...
      <section
        id="pagos-sec"
        style={{ background: "#fff", padding: "70px 5vw 80px" }}
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <div
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: ".7rem", color: `${DARK}66` }}>
                      {d.pais}
                    </div>
                  </div>
                </div>
      ...
      <footer
        id="contacto-sec"
        style={{ background: DARK, padding: "60px 5vw 40px" }}
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div
            style={{
          ...
          >
            <div>
              ...
              >
                ...
                <span
                  style={{ fontSize: "1.2rem", color: "#fff", fontWeight: 700 }}
                >
                  Rifas Jordyn
                </span>
              </div>
              ...
              >
                Sorteos semanales con premios increíbles.
                <br />
                Táchira, Venezuela.
              </p>
            </div>
            ...
            <div>
              ...
              <a
                ...
                onMouseEnter={(e) => (e.target.style.color = TURQ)}
                onMouseLeave={(e) =>
          ...
          >
            ...
            >
              © 2026 RIFAS JORDYN · TODOS LOS DERECHOS RESERVADOS
            </span>
          </div>
        </div>
      </footer>
